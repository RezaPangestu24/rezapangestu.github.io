          ...
          <div class="card-body">
             ...
             <tbody>
               <tr class="text-center">
                  ...
                  <td>
                    <button data-toggle="modal" data-target="#edit<?= $ssw->id_siswaa ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></button>
                    <a href="<?=base_url('mahasiswa/delete/' .$ssw->id_siswaa) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Kenapa Di Hapus Kak:( ')"><i class="fas fa-trash"></i></a>
                  </td>
...
<!-- Modal Edit -->
<?php foreach ($mahasiswa as $ssw) { ?>
<div class="modal fade" id="edit<?= $ssw->id_siswaa ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <div class="modal-body">
            <form action="<?= base_url('mahasiswa/edit/' .$ssw->id_siswaa) ?>" method="POST">
